...
-- UPDATE 시 서브쿼리 사용 가능
-- 방명수 사원의 급여와 보너스를 유재석 사원과 동일하게 변경
...
DELETE FROM EMP_SALARY WHERE DEPT_CODE = 'D6';
...
/*
   ...
   - 별도의 조건을 제시할 수 없고 ROLOLBACK이 불가능
...
SELECT * FROM EMP_SALARY; -- 테이블 말고 안에있는 데이터만 지워짐 테이블까지 지우려면 DROP
ROLLBACK;
